...
class ReportProcess(RecordManager):
    ...
    def _extract_headers(self, query):
        try:
            ...
            cursor = self.oc_query.select_oc(query, one=False)
    ...
    def _create_report_type_two(self):
        ...
        if not novedad_fichas_nuevas:
            ...
            column_headers_oc = self.oc_query.get_column_headers(queries_oc.get_novedad_fichas_nuevas(), db_type="oc")
    ...
    def _create_report_type_four(self):
        ...
        if not informacion_basica_fichas:
            ...
            column_headers_fichas = self.oc_query.get_column_headers(queries_oc.get_info_basic_data_records(fic_ids)[0], db_type="oc")
            column_headers_fichas.append("Notas")  
